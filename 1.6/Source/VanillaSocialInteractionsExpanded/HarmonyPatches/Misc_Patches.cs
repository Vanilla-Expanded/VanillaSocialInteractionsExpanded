...
namespace VanillaSocialInteractionsExpanded
{
    ...
    {
        private static void Postfix(Caravan __result, IEnumerable<Pawn> pawns, Faction faction, PlanetTile exitFromTile, PlanetTile directionTile, PlanetTile destinationTile, bool sendMessage = true)
        {
            if (VanillaSocialInteractionsExpandedSettings.EnableAspirations)
            {
