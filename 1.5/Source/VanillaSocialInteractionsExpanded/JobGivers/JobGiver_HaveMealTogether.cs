...
namespace VanillaSocialInteractionsExpanded
{
    public class JobGiver_HaveMealTogether : ThinkNode_JobGiver
    {
		protected override Job TryGiveJob(Pawn pawn)
		{
			...
			{
				if (FoodUtility.TryFindBestFoodSourceFor(pawn, pawn, false, out Thing foodSource, out ThingDef foodDef, 
			...
			else if (FoodUtility.TryFindBestFoodSourceFor(pawn, pawn, false, out Thing foodSource, out ThingDef foodDef, 
				canRefillDispenser: false, canUseInventory: true, canUsePackAnimalInventory: false,
						allowForbidden: false, false, allowSociallyImproper: false, pawn.IsWildMan(), false, false, minPrefOverride: FoodPreferability.MealSimple))
			{
